...
abstract class FFAppConstants {
  static const List<String> marcasTemporal = [
    'ITALIKA',
    'BAJAJ',
    'VENTO',
    'HERO',
  ...
  static const List<String> urlImagesMarcas = [
    'https://motospremium.com.mx/wp-content/uploads/2024/02/ITALIKA-CAT-400x542.png',
    'https://motospremium.com.mx/wp-content/uploads/2024/02/BAJAJ-CAT-400x542.png',
    'https://motospremium.com.mx/wp-content/uploads/2024/02/VENTO-CAT-400x542.png',
    'https://motospremium.com.mx/wp-content/uploads/2024/02/HERO-CAT-400x542.png',
    'https://motospremium.com.mx/wp-content/uploads/2024/09/honda-mp.jpg'
  ];
  static const List<int> numeroCatMarca = [228, 232, 234, 222, 258];
  static const List<String> marcasAccesorios = [
    'MOTUL',
    'KOV',
    'MOTODRIVE',
    'RASEN',
  ...
  static const List<String> urlImagenesAccesorios = [
    'https://motospremium.com.mx/wp-content/uploads/2024/10/MOTUL-400x542.png',
    'https://motospremium.com.mx/wp-content/uploads/2024/10/KOV-400x542.png',
    'https://motospremium.com.mx/wp-content/uploads/2024/10/MOTODRIVE-400x542.png',
    'https://motospremium.com.mx/wp-content/uploads/2024/10/RASEN-400x542.png',
    'https://motospremium.com.mx/wp-content/uploads/2024/10/IRON-RACING-400x542.png'
  ];
  static const List<int> numCategoriaMarcaAccesorios = [
    241,
    259,
    260,
    246,
  ...
  static const List<String> regimenFiscalPF = [
    '\n605\t- Sueldos y Salarios e Ingresos Asimilados a Salarioslarios',
    '606\t- Arrendamiento',
    '608\t- Demás ingresos',
  ...
  static const List<String> regimenFiscalPM = [
