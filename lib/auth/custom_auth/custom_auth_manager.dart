...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    motosPremiumAuthUserSubject.add(
      MotosPremiumAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<MotosPremiumAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  MotosPremiumAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = MotosPremiumAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    motosPremiumAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
MotosPremiumAuthUser? currentUser;
