import '/components/mensaje_opciones/mensaje_opciones_widget.dart';
                ...
                Expanded(
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        if (FFAppState().usuarioAutenticacion == '')
                          Column(
                            mainAxisSize: MainAxisSize.max,
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: Image.asset(
                                      'assets/images/2a2e7f0f60b750dfb36c15c268d0118d.jpg',
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                ),
                                            ...
                                            child: InkWell(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  Flexible(
                                                    child: Text(
                                                      'Aviso de Privacidad o Politica de Devoluciones',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .bodyMedium
                                                ...
                                                onPressed: () async {
                                                  ...
                                                  if (FFAppState()
                                                    ...
                                                    FFAppState()
                                                        .usuarioAutenticacion = '';
                                                    FFAppState()
                                                        .passwordAutenticacion = '';
                                                    FFAppState().token = '';
                                                    FFAppState()
                                                        .idCustomerTemporal = 0;
                                                    FFAppState()
