...
class _DireccionesWidgetState extends State<DireccionesWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      future: WooCommerceAPIGroup.obtenerDirecionesUsuarioCall.call(
      ...
      builder: (context, snapshot) {
        ...
        final direccionesObtenerDirecionesUsuarioResponse = snapshot.data!;
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Text(
                                                                          valueOrDefault<
                                                                              String>(
                                                                            getJsonField(
                                                                              direccionesObtenerDirecionesUsuarioResponse.jsonBody,
                                              ...
                                              if (functions
                                                    ...
                                                    functions
                                                        .obtenerDireccionesFacturacion(
                                                            getJsonField(
                                                      direccionesObtenerDirecionesUsuarioResponse
                                                          .jsonBody,
                                                      r'''$.meta_data''',
                                                      true,
                                                    )!),
                                                ...
                                                Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          20.0, 0.0, 0.0, 5.0),
                                                  child: Text(
                                                    'Direcciones de facturación alternas',
                                                  ...
                                                  builder: (context) {
                                                    ...
                                                    return Column(
                                                      ...
                                                      children: List.generate(
                                                          direccionesAd.length,
                                                          (direccionesAdIndex) {
                                                        final direccionesAdItem =
                                                            direccionesAd[
                                                                direccionesAdIndex];
                                                        return Padding(
                                                          padding:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children:
                                                                          ...
                                                                          FlutterFlowIconButton(
                                                                            ...
                                                                            onPressed:
                                                                                () async {
                                                                              _model.nuevalistaElimnarF = await WooCommerceAPIGroup.aadirDireccionFacturacionCall.call(
                                                                                idCustomer: FFAppState().idCustomerTemporal,
                                                                                listaDireccionesJson: functions.eliminarDireccionEnvio(
                                                                                    getJsonField(
                                                                                      functions.obtenerDireccionesFacturacion(getJsonField(
                                                                                        direccionesObtenerDirecionesUsuarioResponse.jsonBody,
                                                                                        r'''$.meta_data''',
                                                                                        true,
                                                                                      )!),
                                                  ...
                                                  builder: (context) {
                                                    ...
                                                    return Column(
                                                      mainAxisSize:
                                                          MainAxisSize.max,
                                                      children: List.generate(
                                                          direccionesAdd.length,
                                                          (direccionesAddIndex) {
                                                        final direccionesAddItem =
                                                            direccionesAdd[
                                                                direccionesAddIndex];
                                                        return Padding(
                                                          padding:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children:
                                                                          ...
                                                                          FlutterFlowIconButton(
                                                                            ...
                                                                            onPressed:
                                                                                () async {
                                                                              _model.nuevalistaElimnarE = await WooCommerceAPIGroup.aadirDireccionEnvioCall.call(
                                                                                idCustomer: FFAppState().idCustomerTemporal,
                                                                                listaDireccionesJson: functions.eliminarDireccionEnvio(
                                                                                    getJsonField(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                context.pushNamed(
                                                  AadirnuevaDirecciionDeEnvioWidget
                                                      .routeName,
                                                  extra: <String, dynamic>{
                                                    kTransitionInfoKey:
                                                        TransitionInfo(
