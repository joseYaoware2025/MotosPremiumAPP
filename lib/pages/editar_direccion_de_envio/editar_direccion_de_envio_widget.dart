...
import 'editar_direccion_de_envio_model.dart';
export 'editar_direccion_de_envio_model.dart';

class EditarDireccionDeEnvioWidget extends StatefulWidget {
  const EditarDireccionDeEnvioWidget({super.key});

  static String routeName = 'EditarDireccionDeEnvio';
  static String routePath = '/editarDireccionDeEnvio';

  @override
  State<EditarDireccionDeEnvioWidget> createState() =>
      _EditarDireccionDeEnvioWidgetState();
}

class _EditarDireccionDeEnvioWidgetState
    extends State<EditarDireccionDeEnvioWidget> {
  late EditarDireccionDeEnvioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarDireccionDeEnvioModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final editarDireccionDeEnvioObtenerDatosCustomerResponse =
            snapshot.data!;
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      controller: _model.textController1 ??=
                                        ...
                                        text: getJsonField(
                                                  editarDireccionDeEnvioObtenerDatosCustomerResponse
                                                      .jsonBody,
