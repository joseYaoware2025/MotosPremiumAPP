...
class _InicioWidgetState extends State<InicioWidget>
  ...
  Future<bool> onWillPop() async {
    ...
    if (lastPressed == null || now.difference(lastPressed!) > duration) {
      ...
      return false; // Bloquea la salida hasta que se presione nuevamente
    }

    if (Platform.isAndroid) {
      SystemNavigator.pop(); // Cierra la app en Android de manera segura
    } else if (Platform.isIOS) {
      exit(
          0); // En iOS, no hay otra opción más que exit(0) (aunque no recomendado)
    }
